...
const Lead = () => {
  ...
  const columns = [
    ...
    { field: 'lead_name', headerName: 'Lead Name',      flex:1},
    {
      field: 'full_name', headerName: 'Customer',
      valueGetter: params => params.row.customer.full_name
    },
    {
      field: 'name', headerName: 'Sale Person', valueGetter: params => params.row.sale_person.name, headerAlign: "left",
      align: "left",

    },
    {
      field: 'status', headerName: 'Status', headerAlign: "left",
      align: "left",
    },
    {
      field: "Action",
  ...
  return (
    <Box m="20px" >
      <Header title="Lead" subTitle="Managing the sales lead" />
      <hr />
      <Button  variant="contained" color="success" size="large" startIcon={<AddIcon />}>Add Lead</Button>
      ...
      >
        <DataGrid rows={modifiedLeads} columns={columns} onRowClick={handleRowClick} />
      </Box>
    </Box>
  );
};
